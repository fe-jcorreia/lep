      ...
      {isWideVersion ? (
            ...
            <Flex h="100%" color="white">
              <HStack spacing="5rem">
                ...
                <Box w="20%" textAlign="justify" h="100%">
                  ...
                  <Text fontSize="sm">
                    A Liga de Empreendedorismo da Poli foi fundada em dezembro
                    de 2019. Nossa principal missão é sermos vetores de criação
                    de um ecossistema empreendedor dentro da Poli, assim como,
                    das futuras grandes inovações brasileiras.
                  </Text>
                </Box>
        ...
        <>
          <Flex
            ...
            justify="space-between"
          >
            <Flex h="100%" color="white" flexDirection="column">
              <SimpleGrid gap="2rem" columns={[1, 1, 1, 4]}>
                <Box mx="auto" w={["25%", "10%"]} h="100%">
                  <Image
                    src="/img/icon-bluebg.png"
                    w="100%"
                    h="auto"
          ...
          <Text mt="2rem" textAlign="center" color="white" mb="1rem">
            Liga de Empreendedorismo da POLI
